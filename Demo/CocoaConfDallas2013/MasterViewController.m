...
- (void)insertNewObject:(id)sender
{
    ...
    NSDictionary *datum = [appDelegate nextSampleDatum];
    [newEvent setValue:[datum valueForKey:@"firstName"] forKey:@"firstName"];
    [newEvent setValue:[datum valueForKey:@"lastName"] forKey:@"lastName"];
    [newEvent setValue:[datum valueForKey:@"email"] forKey:@"email"];
    [newEvent setValue:[datum valueForKey:@"image"] forKey:@"image"];
...
{
    NSManagedObject *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
    NSString *name = [object valueForKey:@"fullName"];
    if (name == nil) {
        name = [[object valueForKey:@"timeStamp"] description];
    }
    cell.textLabel.text = name;
    cell.detailTextLabel.text = [object valueForKey:@"email"];
